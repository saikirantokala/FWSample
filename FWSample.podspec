#
#  Be sure to run `pod spec lint FWSample.podspec' to ensure this is a
...
FWSample is to test framework working or not with Cocoapods. After integrating this one, just it will print SampleString in your project
  ...
  spec.source       = { :git => "https://github.com/saikirantokala/FWSample.git", :tag => spec.version.to_s }
  ...
  spec.source_files = 'FWSample.framework/Headers/*.h'
  spec.public_header_files = "FWSample.framework/Headers/*.h"
  spec.ios.vendored_frameworks = "FWSample.framework"
